...
public class Instance {
	...
	@JsonCreator
	public Instance(@JsonProperty("instanceId") String instanceId, @JsonProperty("ipAddr") String ipAddr, @JsonProperty("port") Port port) {
		this.instanceId = instanceId;
		this.ipAddr = ipAddr;
		this.port = port;
	}

	public Instance(String hostName, String app, String ipAddr, String zone, int port) {
