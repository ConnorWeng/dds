...
public class DDSClientExpireForRemoteZoneTest {
	private String providerConf = "provider.conf";
	private String providerConfB = "providerB.conf";
	private String consumerConf = "consumer.conf";
	private DDSClient aProvider;
	private DDSClient bProvider;

	@Test
	public void expireForRemoteZoneTest() {
	...
	public void setUp() throws Exception {
		...
		this.bProvider = new DDSClient(providerConfB);
		bProvider.setRetry(1);
		bProvider.register();
